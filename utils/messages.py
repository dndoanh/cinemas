MSG_BEGIN = "Please define movie title and seating map in [Title] [Row] [SeatsPerRow] format:"
MSG_WELCOME = (
    "Welcome to GIC Cinemas\n[1] Book tickets for {movie_title} ({seats_available} seats available)\n[2] Check bookings\n[3] Exit\nPlease enter your selection:"
)
MSG_INPUT_NUMBER_OF_TICKETS = "Enter number of tickets to book, or enter blank to go back to main menu:"
MSG_INPUT_SEATING_POSITION = "Enter blank to accept seat selection, or enter new seating position:"
MSG_INPUT_BOOKING_ID = "Enter booking id, or enter blank to go back to main menu:"
MSG_OUTPUT_SUCCESSFULLY_RESERVED = "Successfully reserved {num_tickets} {movie_title} tickets."
...
MSG_INVALID_MOVIE_TITLE_ROWS_SEATS_PER_ROW = "Invalid movie title or rows or seats per row. Please try again."
...
MSG_INVALID_EXCEEDING_NUMBER_OF_TICKETS = "Sorry, there are only {num_seats} seats available."
