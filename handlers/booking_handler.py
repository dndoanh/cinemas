...
class BookingHandler:
    def __init__(
        self, io_handler: IOHandler = None, cinema_handler: CinemaHandler = None
    ) -> None:
        ...
        Args:
            ...
            cinema_handler(CinemaHandler): the handler of cinema creation.
        """
        if io_handler is None:
            io_handler = ConsoleIOHandler()
        if cinema_handler is None:
            cinema_handler = CinemaHandler()
        self.io_handler: IOHandler = io_handler
        self.cinema_handler: CinemaHandler = cinema_handler
